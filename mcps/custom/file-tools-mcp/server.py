...
TOOLS = [
    ...
    Tool(
        ...
        description=(
            ...
            "ADDRESSING: all cell references use A1 notation — columns are "
            "LETTERS, rows are 1-based NUMBERS ('B2' = column B, row 2). "
            "The result echoes a coordinate-labeled readback grid of the "
            "written range — check it to confirm values landed in the "
            "intended cells.\n\n"
            ...
            "add_equation (latex, cell, height in px — renders a LaTeX equation "
            "as a picture anchored at the cell with the LaTeX source in a cell "
